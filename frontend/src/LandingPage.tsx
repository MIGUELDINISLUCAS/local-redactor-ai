...
const MAC_DMG = 'https://github.com/MIGUELDINISLUCAS/local-redactor-ai/releases/download/v0.1.2/Local.Redactor.AI-arm64.dmg';
const WIN_EXE = 'https://github.com/MIGUELDINISLUCAS/local-redactor-ai/releases/download/v0.1.2/Local.Redactor.AI-Setup.exe';
